...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="page-container">
        ...
        <form action="{{ url('/teams') }}" method="POST">
            ...
            <input type="number" class="col-3 form-control" id="players" name="players" placeholder="Número de jogadores por equipe" style="margin: 10px auto; text-align: center !important;" required>
