    ...
    <body class="page-container">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                ...
                <p class="lead">Crie novas partidas. Jogadores podem ser cadastrados durante a confirmação de presença.</p>
            </div>
        </div>
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="col-3">Jogadores Confirmados</th>
                    <th scope="col" class="col-3">Confirmar Presenças/ Gerar Equipes</th>
                </tr>
            </thead>
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-outline-success">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar2-check-fill" viewBox="0 0 448 512">
        ...
        <a href="/game/create" class="btn btn-success" style="margin: 20px 0">
        ...
        <!-- Including jQuery and Bootstrap JavaScript files -->
