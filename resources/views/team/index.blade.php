...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Gerenciar {{$game['label']}}</title>
    </head>
    <body class="page-container">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                ...
                <p class="lead">Visualizando equipes para a partida: <b>{{$game['label']}}</b></p>
            </div>
        </div>
        ...
        <form action="{{ url('/teams') }}" method="POST">
            ...
            <input type="number" class="col-3 form-control" id="players" name="players" placeholder="Número de jogadores por equipe" min="1" style="margin: 10px auto; text-align: center !important;" required>
        ...
        @if (count($teams) > 0)
            ...
            @if (array_key_exists(3, $teams))
                <hr/>
                <div class="table-responsive col-md-6" style="margin: auto;">
                    <h5 style="margin: 30px 0;"><b>Banco de Reservas: </b></h5>
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                <th scope="col" class="col-3">Nome do Jogador</th>
