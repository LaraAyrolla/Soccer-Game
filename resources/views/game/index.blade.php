...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="page-container">
        ...
        <a href="/game/create" class="btn btn-success" style="margin-bottom: 30px">
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="col-3">Presenças e Equipes</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach($games as $game)
                        <tr>
                            <td>{{ $game['label'] }}</td>
                            <td>{{ $game['date'] }}</td>
                            <td>{{ $game['players_amount'] }}</td>
                            <td>
                                <a href="/game/{{$game['id']}}" class="btn btn-primary" title="Visualizar ou Confirmar Jogadores">
                                ...
                                <a href="/team/index/{{$game['id']}}" class="btn btn-success" title="Visualizar ou Gerar Equipes">
