    ...
    <body class="page-container">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                ...
                <p class="lead">Gerenciando a partida: <b>{{$game['label']}}</b></p>
            </div>
        </div>
        ...
        <a href="/available-players/{{$game['id']}}" class="btn btn-primary" style="margin-bottom: 30px">
        ...
        @if (count($gamePlayers) > 0)
            <h5 style="margin: 30px 0;"><b>Jogadores Confirmados: </b></h5>
        ...
        @else
            <p>Nenhum jogador confirmado para a partida! Clique no botão acima para adicionar jogadores.</p>
        @endif
    </body>
</html>
